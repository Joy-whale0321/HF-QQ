...
void Fun4All_PhotonConv_Reco(
    ...
    const std::string trkr_trackfilename = "DST_TRKR_TRACKS_run2pp_ana506_2024p023_v001-00053877-00017.root",
    ...
    const std::string calofilename = "DST_CALO_run2pp_ana509_2024p022_v001-00053877-00001.root",
