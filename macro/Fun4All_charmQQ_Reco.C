...
void Fun4All_charmQQ_Reco(
    const int nEvents = 10,
    const std::string trackfilename = "DST_STREAMING_EVENT_run2pp_new_2024p002-00053222-00000.root",
    const std::string trackdir = "/sphenix/lustre01/sphnxpro/physics/slurp/streaming/physics/new_2024p002/run_00053200_00053300/",
    ...
    const int stepsize = 10)
{
    ...
    Enable::CDB = true;
    rc->set_StringFlag("CDB_GLOBALTAG", "ProdA_2024"); // whats this setting?
    ...
    hitsin_track->fileopen(inputTrackFile);
